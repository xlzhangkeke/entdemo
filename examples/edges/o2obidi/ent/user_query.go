...
import (
	"context"
	"fmt"
	"github.com/xlzhangkeke/entdemo/examples/edges/o2obidi/ent/predicate"
	user2 "github.com/xlzhangkeke/entdemo/examples/edges/o2obidi/ent/user"
	"math"
...
func (uq *UserQuery) QuerySpouse() *UserQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(user2.Table, user2.FieldID, selector),
			sqlgraph.To(user2.Table, user2.FieldID),
			sqlgraph.Edge(sqlgraph.O2O, false, user2.SpouseTable, user2.SpouseColumn),
		)
...
func (uq *UserQuery) First(ctx context.Context) (*User, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{user2.Label}
	}
	return nodes[0], nil
}
...
func (uq *UserQuery) Only(ctx context.Context) (*User, error) {
	...
	case 0:
		return nil, &NotFoundError{user2.Label}
	default:
		return nil, &NotSingularError{user2.Label}
	}
}
...
func (uq *UserQuery) OnlyID(ctx context.Context) (id int, err error) {
	...
	case 0:
		err = &NotFoundError{user2.Label}
	default:
		err = &NotSingularError{user2.Label}
	}
	return
}
...
func (uq *UserQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := &sqlgraph.QuerySpec{
		Node: &sqlgraph.NodeSpec{
			Table:   user2.Table,
			Columns: user2.Columns,
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeInt,
				Column: user2.FieldID,
			},
		},
		From:   uq.sql,
		Unique: true,
	...
	if fields := uq.fields; len(fields) > 0 {
		...
		_spec.Node.Columns = append(_spec.Node.Columns, user2.FieldID)
		for i := range fields {
			if fields[i] != user2.FieldID {
