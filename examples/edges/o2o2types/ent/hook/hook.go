...
import (
	"context"
	"fmt"
	ent2 "github.com/xlzhangkeke/entdemo/examples/edges/o2o2types/ent"
)

// The CardFunc type is an adapter to allow the use of ordinary
// function as Card mutator.
type CardFunc func(context.Context, *ent2.CardMutation) (ent2.Value, error)

// Mutate calls f(ctx, m).
func (f CardFunc) Mutate(ctx context.Context, m ent2.Mutation) (ent2.Value, error) {
	mv, ok := m.(*ent2.CardMutation)
	if !ok {
