...
import (
	...
	"errors"
	"fmt"
	card2 "github.com/xlzhangkeke/entdemo/examples/edges/o2o2types/ent/card"
	"github.com/xlzhangkeke/entdemo/examples/edges/o2o2types/ent/migrate"
	user2 "github.com/xlzhangkeke/entdemo/examples/edges/o2o2types/ent/user"
	"log"
...
func (c *CardClient) DeleteOneID(id int) *CardDeleteOne {
	builder := c.Delete().Where(card2.ID(id))
...
func (c *CardClient) Get(ctx context.Context, id int) (*Card, error) {
	return c.Query().Where(card2.ID(id)).Only(ctx)
}
...
func (c *CardClient) QueryOwner(ca *Card) *UserQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(card2.Table, card2.FieldID, id),
			sqlgraph.To(user2.Table, user2.FieldID),
			sqlgraph.Edge(sqlgraph.O2O, true, card2.OwnerTable, card2.OwnerColumn),
		)
...
func (c *UserClient) DeleteOneID(id int) *UserDeleteOne {
	builder := c.Delete().Where(user2.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
...
func (c *UserClient) QueryCard(u *User) *CardQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(user2.Table, user2.FieldID, id),
			sqlgraph.To(card2.Table, card2.FieldID),
			sqlgraph.Edge(sqlgraph.O2O, false, user2.CardTable, user2.CardColumn),
		)
