...
import (
	...
	"errors"
	"fmt"
	"github.com/xlzhangkeke/entdemo/examples/edges/o2mrecur/ent/migrate"
...
func (c *NodeClient) DeleteOneID(id int) *NodeDeleteOne {
	builder := c.Delete().Where(node2.ID(id))
...
func (c *NodeClient) Get(ctx context.Context, id int) (*Node, error) {
	return c.Query().Where(node2.ID(id)).Only(ctx)
}
...
func (c *NodeClient) QueryParent(n *Node) *NodeQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(node2.Table, node2.FieldID, id),
