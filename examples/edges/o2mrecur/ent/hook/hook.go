...
import (
	"context"
	"fmt"
	ent2 "github.com/xlzhangkeke/entdemo/examples/edges/o2mrecur/ent"
)

// The NodeFunc type is an adapter to allow the use of ordinary
// function as Node mutator.
type NodeFunc func(context.Context, *ent2.NodeMutation) (ent2.Value, error)

// Mutate calls f(ctx, m).
func (f NodeFunc) Mutate(ctx context.Context, m ent2.Mutation) (ent2.Value, error) {
	mv, ok := m.(*ent2.NodeMutation)
	if !ok {
